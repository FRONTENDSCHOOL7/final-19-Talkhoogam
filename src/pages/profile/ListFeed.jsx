...
export default function ListFeed(){
    ...
    return (
        ...
        myFeedData.post.map((item, index) => (
            ...
            <List key={item.id}>
            <img className="list-profileimg" src={item.author.image} alt="프로필이미지"/>
            <div className="feedlist">
                ...
                <img onClick={myFeedData} className="list-img" src={item.image} alt="피드 사진" />
                <p className="list-text">{item.content}
                </p>
